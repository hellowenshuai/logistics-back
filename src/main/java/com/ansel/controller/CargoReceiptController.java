...
public class CargoReceiptController extends ReturnType {
     ...
     * 通过货运回执单查询客户信息
     */
    @ApiOperation(value = "通过货运回执单查询客户信息")
    ...
    public Result selectByEvent(@PathVariable("backBillState") String backBillState,
     ...
     * 提交货运回执单  发货操作
     */
    @ApiOperation(value = "提交货运回执单  发货操作")
     ...
     * 删除货运回执单
     */
    @ApiOperation(value = "删除货运回执单", notes = "逻辑删除")
    ...
    public Result findByDriverId(@PathVariable("id") String driverId,
                                 @PathVariable("state") String backBillState,
                                 @RequestParam("pageNum") int pageNum,
                                 @RequestParam("limit") int limit) {
        Pageable pageable = PageRequest.of(pageNum - 1, limit);
