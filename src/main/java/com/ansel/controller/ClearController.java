...
public class ClearController extends ReturnType {
     ...
     */
    @ApiOperation(value = "司机结算-返回未结的所有实体(实体中能填的属性都填好)")
     ...
     */
    @ApiOperation(value = "司机结算-通过订单编号查询单个实体的已填所有信息")
     ...
     * 司机结算（前台返回一个完整的实体）
     */
    @ApiOperation(value = "司机结算（前台返回一个完整的实体）")
     ...
     */
    @ApiOperation(value = "客户结算-返回未结的所有实体(实体中能填的属性都填好)")
     ...
     */
    @ApiOperation(value = "客户结算-通过订单编号查询单个实体的已填所有信息")
     ...
     * 客户结算（前台返回一个完整的实体）
     */
    @ApiOperation(value = "客户结算（前台返回一个完整的实体）")
     ...
     */
    @ApiOperation(value = "代收结算-返回未结的所有实体(实体中能填的属性都填好)")
     ...
     */
    @ApiOperation(value = "代收结算-通过订单编号查询单个实体的已填所有信息")
     ...
     * 代收结算（前台返回一个完整的实体）
     */
    @ApiOperation(value = "代收结算（前台返回一个完整的实体）")
     ...
     * 杂费结算  select
     */
    @ApiOperation(value = "杂费结算  select")
